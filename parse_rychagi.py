"""
Парсер каталога рычагов зажимных с alterv.ru/catalog/rychagi_zazhimnye/
...
CATALOG_URL = "https://alterv.ru/catalog/rychagi_zazhimnye/"
OUT_FILE = "alterv_rychagi.csv"
...
def get_product_links(page):
    ...
    try:
        ...
        page.evaluate("var el=document.getElementById('altasib_geobase_window_block'); if(el) el.style.display='none'")
    except Exception:
        pass

    # Кликаем "Показать еще" через JS пока кнопка есть
    click_count = 0
    while True:
