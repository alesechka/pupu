"""Проверяет какие подкатегории opory есть на сайте но отсутствуют в CSV."""
import csv
from bs4 import BeautifulSoup
from playwright.sync_api import sync_playwright

# Читаем существующие URL из CSV
existing_urls = set()
...
print(f"Существующих URL в CSV: {len(existing_urls)}")

# Собираем все URL с сайта
