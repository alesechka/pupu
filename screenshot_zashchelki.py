"""
Скриншоты таблиц flt-table для каталога защёлок накидных.
Clean вариант: убирает "Сбросить фильтр", обрезает от "Наличие", убирает "В избранное".
Результат в папке table_screenshots_zashchelki/
"""
...
CATALOG_URL = "https://alterv.ru/catalog/zashchelki_nakidnye/"
OUT_DIR = "table_screenshots_zashchelki"
