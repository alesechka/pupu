"""
Парсер каталога фиксаторов поворотных с alterv.ru/catalog/fiksatory_povorotnye/
Поддерживает пагинацию и несколько таблиц flt-table на странице товара.
"""
