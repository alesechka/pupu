"""Проверяет какие товары stanok есть на сайте но отсутствуют в CSV."""
import csv, time
from bs4 import BeautifulSoup
from playwright.sync_api import sync_playwright

existing_urls = set()
with open("alterv_stanok.csv", encoding="utf-8-sig") as f:
...
CATALOG_URL = "https://alterv.ru/catalog/stanochnye_prisposobleniya/"
...
with sync_playwright() as p:
    ...
    while True:
        ...
        print(f"  Стр.{page_num}: товаров={len(items)}, всего={len(site_links)}")
