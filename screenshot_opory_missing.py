"""Скриншоты для 6 недостающих товаров opory — латиница, обрезка по Наличие"""
...
OUT_DIR = "table_screenshots_opory_missing"
...
def screenshot_tables(page, url):
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for url in MISSING_URLS:
            print(f"\n{url}")
            try: screenshot_tables(page, url)
