"""
Скриншоты таблиц flt-table для каталога элементов системы смазки и гидравлических механизмов.
Clean вариант: убирает "Сбросить фильтр", обрезает от "Наличие", убирает "В избранное".
Результат в папке table_screenshots_smazka/
"""
...
OUT_DIR = "table_screenshots_smazka"
